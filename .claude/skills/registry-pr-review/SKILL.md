---
name: registry-pr-review
description: Review a dapp-index pull request for serious issues only — correctness, security, wallet safety, trust/governance regressions, schema compatibility, missing tests for changed behavior, and broken release flows. Never edits files or reveals secrets. Use for PR review in this repo specifically; for a general GitHub PR review outside dapp-index's conventions, use the built-in review skill instead.
---
