...
export function listDirectoryTestFixtures(): DappIndexEntry[] {
  return [
    ...
    },
    {
      ...
      schemaVersion: DAPP_INDEX_METADATA_SCHEMA_VERSION,
      id: 's3-route-planner',
      name: 'S3 Route Planner',
      summary: 'Plans fleet routes with an S3-hosted demo walkthrough.',
      categories: ['logistics'],
      smartAssemblyTypes: ['storage-unit'],
      serverTenant: 'stillness',
      liveUrl: 'https://s3-route-planner.example',
      suiPackages: [],
      media: {
        thumbnail: 'thumbnail',
        items: [
          {
            ...
            kind: 'image',
            role: 'thumbnail',
            uri: 'https://cdn.example/testnet/0xabc/s3-route-planner/thumbnail.webp',
            mimeType: 'image/webp',
            sha256: HEX_32,
            sizeBytes: 300_000,
            width: 1600,
            height: 900,
            alt: 'S3 Route Planner dashboard',
          },
          {
            id: 'demo',
            kind: 'video',
            role: 'demo',
            uri: 'https://cdn.example/testnet/0xabc/s3-route-planner/demo.webm',
            mimeType: DAPP_INDEX_VIDEO_MIME_TYPE,
            sha256: HEX_32,
            sizeBytes: 4_200_000,
            width: 1920,
            height: 1080,
            alt: 'S3 Route Planner demo',
            caption: 'Creating a route and handing it off to a fleet',
            poster: {
              uri: 'https://cdn.example/testnet/0xabc/s3-route-planner/demo-poster.webp',
              mimeType: 'image/webp',
              sha256: HEX_32,
              sizeBytes: 90_000,
              width: 1920,
